...
// 일정 CUD
const martixContainer = document.querySelector(".matrix-container");
martixContainer.addEventListener("keypress", cudController);
martixContainer.addEventListener("click", cudController);
